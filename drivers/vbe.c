 ...
 * Deseneaza pixeli, dreptunghiuri, text pe ecran
 *
 * GRUB seteaza modul grafic inainte de a apela kernelul.
 * Adresa framebuffer-ului vine din structura Multiboot.
 * Pentru MVP, folosim adresa standard 0xFD000000 (poate varia!)
 */
...
/* Font 8x8 incorporat (ASCII 32-127) - versiune simplificata */
/* Fiecare caracter = 8 bytes, fiecare byte = 1 rand de 8 pixeli */
static const uint8_t font8x8[96][8] = {
    ...
    /* ... (font complet ar fi mult mai lung, acesta e un stub) */
    /* 0x41 A     */ { 0x18,0x3C,0x66,0x7E,0x66,0x66,0x66,0x00 },
    /* 0x42 B     */ { 0x7C,0x66,0x66,0x7C,0x66,0x66,0x7C,0x00 },
    /* 0x4C L     */ { 0x60,0x60,0x60,0x60,0x60,0x66,0x7E,0x00 },
...
/* ============================================================
 *  vbe_init - Initializeaza framebuffer-ul
